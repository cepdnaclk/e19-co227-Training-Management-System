...
function EmailTemplateToApplicants({ mailSubject, mailbody, receiverName, receiverMail }) {

  return (
    <div className="p-4 w-1/2 lg:w-2/6 mb-5">
      <div className="mb-4">
        <label className="block mb-2">Participant : {receiverName}</label>
        <label className="block text-gray-600 mb-2">To : </label>
        <div type="text" className="border rounded-md w-full py-1 px-3">
          <span>{receiverMail}</span>
        </div>
      </div>
...
export default EmailTemplateToApplicants